...
public class calibrationScreen implements Screen {
    ...
    // Texture for calibration target
    private Texture calibTarget;

    // Texture for calibration crosshair
    ...
    private Rectangle calibTargetRec;
    ...
    public calibrationScreen(BirdsVoyage host) {
        ...
        // Loads calibration target texture
        calibTarget = new Texture(Gdx.files.internal("calibration.png"));
        ...
        calibTargetRec = new Rectangle(
                250,
                100,
                calibTarget.getWidth(),
                calibTarget.getHeight()
        );
    }
    ...
    public void render(float delta) {
        ...
        host.batch.draw(calibTarget, calibTargetRec.getX(), calibTargetRec.getY());
